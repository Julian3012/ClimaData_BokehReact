...
x_axis = Select(title="X Axis", options=options, value="None")
y_axis = Select(title="Y Axis", options=options, value="None")
color_axis = Select(title="Color", options=options, value="None")
...
controls = [x_axis, y_axis, color_axis]
